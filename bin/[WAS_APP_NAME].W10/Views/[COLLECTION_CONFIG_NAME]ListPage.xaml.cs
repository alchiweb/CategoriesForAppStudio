...
namespace [WAS_APP_NAME].Views
{
    public sealed partial class [COLLECTION_CONFIG_NAME]ListPage : PageBase
    {
        ...
        {
            this.ViewModel = new ListViewModelWithCategories<[COLLECTION_SCHEMA_NAME]Schema>(new [COLLECTION_CONFIG_NAME]Config());
            this.InitializeComponent();
        }

        public ListViewModelWithCategories<[COLLECTION_SCHEMA_NAME]Schema> ViewModel { get; set; }
